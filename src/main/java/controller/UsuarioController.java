        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch (action) {
                case "/loginUser":
                    ...
                    response.sendRedirect("/popcornburster/views/main.jsp");
                    break;
                ...
                case "/createUser":
                    ...
                    response.sendRedirect ("/popcornburster/views/userCreado.jsp");
                    break;
                ...
                case "/viewUser":
                    ...
                    response.sendRedirect("/popcornburster/views/edicion.jsp");
                    break;
